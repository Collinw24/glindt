...
@Suite struct GlindtCoreSmokeTests {
    @Test func packageLinks() {
        // If this compiles and runs, GlindtCore loaded.
    }
}
...
@Suite struct M0aPublicInitTests {
    ...
    /// lives in the app target, so this exercises the GlindtCore model
    ...
    @Test func hermesPathSetDerivations() {
        ...
        #expect(local.projectsRegistry == "/Users/alan/.hermes/glindt/projects.json")
    ...
    @Test func projectDashboardInitChain() {
        ...
        #expect(entry.dashboardPath == "/a/b/demo/.glindt/dashboard.json")
