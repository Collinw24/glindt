...
///
/// Promoted from the Mac target into GlindtCore in v2.5 so iOS and Mac
...
public final class ProjectSessionsViewModel {
    private static let logger = Logger(subsystem: "com.glindt", category: "ProjectSessionsViewModel")
