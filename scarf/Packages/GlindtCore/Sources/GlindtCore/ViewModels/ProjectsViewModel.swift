...
public final class ProjectsViewModel {
    private let logger = Logger(subsystem: "com.glindt", category: "ProjectsViewModel")
    ...
    /// Per-project `.glindt/` directories — watched alongside `dashboardPaths`
    ...
    public var projectGlindtDirs: [String] {
        projects.map(\.glindtDir)
    }
