...
public enum KanbanToolsetState: Sendable, Equatable {
    ...
    public enum Source: Sendable, Equatable {
        ...
        /// in a Glindt-driven ACP chat. Included for completeness so
        /// the detector's contract is exhaustive even though Glindt
...
///
/// **Why this lives at the GlindtCore layer.** Both Mac and iOS need
