...
/// Tracks "what skills did this Glindt instance see last time on this
...
/// `~/Library/Application Support/com.glindt/skill-snapshots/<serverID>.json`;
/// iOS persists to `UserDefaults` under
/// `com.glindt.ios.skill-snapshot.<serverID>`. Both stores hold a
...
/// `~/Library/Application Support/com.glindt/skill-snapshots/`.
public struct MacSnapshotBackend: Sendable {
    ...
    private static func fileURL(for serverID: ServerID) -> URL? {
        ...
        return appSupport
            .appendingPathComponent("com.glindt", isDirectory: true)
...
public final class IOSSnapshotBackend: @unchecked Sendable {
    public static let keyPrefix = "com.glindt.ios.skill-snapshot."
