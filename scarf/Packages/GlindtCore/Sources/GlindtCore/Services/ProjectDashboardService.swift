...
public struct ProjectDashboardService: Sendable {
    private static let logger = Logger(subsystem: "com.glindt", category: "ProjectDashboardService")
    ...
    public func loadRegistry() -> ProjectRegistry {
        ...
        GlindtMon.measure(.diskIO, "dashboard.loadRegistry") {
    ...
    /// Persist the project registry to `~/.hermes/glindt/projects.json`.
    ///
