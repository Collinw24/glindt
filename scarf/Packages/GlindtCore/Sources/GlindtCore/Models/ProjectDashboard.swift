...
public struct ProjectEntry: Codable, Sendable, Identifiable, Hashable {
    ...
    public var dashboardPath: String { path + "/.glindt/dashboard.json" }

    /// Directory holding the project's Glindt-managed sidecar files
    ...
    public var glindtDir: String { path + "/.glindt" }
...
public struct DashboardWidget: Codable, Sendable, Identifiable {
    ...
    // contains `.glindt/`). Renderers must reject `..` segments after
