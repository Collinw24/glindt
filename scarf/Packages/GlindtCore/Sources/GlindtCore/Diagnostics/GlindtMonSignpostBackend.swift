...
/// users can attach Instruments and see Glindt's instrumentation in the
...
public final class GlindtMonSignpostBackend: GlindtMonBackend, @unchecked Sendable {
    #if canImport(os)
    private let log: OSLog

    public init(subsystem: String = "com.glindt.mon") {
