...
public final class NetworkReachabilityService {
    ...
    private let queue = DispatchQueue(label: "com.glindt.ios.reachability")

    #if canImport(os)
    private static let logger = Logger(subsystem: "com.glindt.ios", category: "NetworkReachability")
    #endif
