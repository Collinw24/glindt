//
//  GlindtTheme.swift
//  Glindt Design System — Swift token bridge
//
//  Mirrors colors_and_type.css. All colors resolve from GlindtBrand.xcassets,
//  so light/dark variants come from the asset catalog automatically.
//
//  Usage:
//    Text("Hello").foregroundStyle(GlindtColor.foregroundPrimary)
//    RoundedRectangle(cornerRadius: GlindtRadius.lg)
//        .fill(GlindtColor.backgroundSecondary)
//        .overlay(RoundedRectangle(cornerRadius: GlindtRadius.lg)
//            .strokeBorder(GlindtColor.border, lineWidth: 1))
//
//  Drop-in: add this file + GlindtBrand.xcassets to your target. Nothing else.
//
...
/// All Glindt brand colors. Resolves from GlindtBrand.xcassets (light + dark).
public enum GlindtColor {
    ...
    public enum Tool {
        public static let bash   = GlindtColor.asset("Tool/ToolBash")
        public static let edit   = GlindtColor.asset("Tool/ToolEdit")
        public static let search = GlindtColor.asset("Tool/ToolSearch")
        public static let web    = GlindtColor.asset("Tool/ToolWeb")
        public static let think  = GlindtColor.asset("Tool/ToolThink")
    }
}

// MARK: - Gradients

public enum GlindtGradient {
...
public struct GlindtShadow {
    public let color: Color
    public let radius: CGFloat
    public let x: CGFloat
    public let y: CGFloat

    public static let sm = GlindtShadow(color: .black.opacity(0.05), radius: 2, x: 0, y: 1)
    public static let md = GlindtShadow(color: .black.opacity(0.07), radius: 12, x: 0, y: 4)
    public static let lg = GlindtShadow(color: .black.opacity(0.10), radius: 24, x: 0, y: 8)
    public static let xl = GlindtShadow(color: .black.opacity(0.14), radius: 40, x: 0, y: 16)
}

public extension View {
    func glindtShadow(_ s: GlindtShadow) -> some View {
...
public enum GlindtAnimation {
    ...
    public static let fast   = Animation.easeOut(duration: GlindtDuration.fast)
    public static let base   = Animation.easeOut(duration: GlindtDuration.base)
}
