...
struct GlindtIOSApp: App {
    ...
    init() {
        // GlindtMon — open-source perf instrumentation. Reads the
        ...
        GlindtMonBoot.configure(mode: GlindtMonBoot.currentMode())

        // Wire GlindtCore's transport factory to produce Citadel-backed
        ...
        WindowGroup {
            RootView(model: root)
                ...
                .task {
                    ...
                    // land in Documents/GlindtDiagnostics/ where the
                ...
                // Clamp Dynamic Type at the scene root. GlindtGo is a
...
/// Decides what screen GlindtGo shows. M9 added the `.serverList`
...
final class RootModel {
    ...
    /// SwiftUI `.onDisappear` when GlindtGoTabRoot unmounts; on next
