...
/// GlindtGo's primary navigation surface. v2.5 expands the original
...
struct GlindtGoTabRoot: View {
    ...
    /// through here.
    @State private var coordinator = GlindtGoCoordinator()
    ...
    var body: some View {
        ...
        TabView(selection: $coordinator.selectedTab) {
            ...
            .tag(GlindtGoCoordinator.Tab.dashboard)
            ...
            .tag(GlindtGoCoordinator.Tab.projects)
            ...
            .tag(GlindtGoCoordinator.Tab.chat)
            ...
            .tag(GlindtGoCoordinator.Tab.skills)
            ...
            .tag(GlindtGoCoordinator.Tab.system)
        ...
        .environment(\.glindtGoCoordinator, coordinator)
    ...
    var body: some View {
        List {
            ...
            Section("Features") {
                ...
                .glindtGoCompactListRow()
                .listRowBackground(GlindtColor.backgroundSecondary)
                if capabilitiesStore?.capabilities.hasCurator ?? false {
                    NavigationLink {
                        CuratorView(context: config.toServerContext(id: GlindtGoTabRoot.systemTabContextID))
                    } label: {
