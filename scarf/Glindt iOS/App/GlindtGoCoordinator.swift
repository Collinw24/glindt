...
/// Cross-tab signalling for GlindtGo. Mirrors the Mac app's
...
@Observable
@MainActor
final class GlindtGoCoordinator {

    /// Which tab GlindtGoTabRoot should present. Changing this from
...
/// explicit threading.
private struct GlindtGoCoordinatorKey: EnvironmentKey {
    static let defaultValue: GlindtGoCoordinator? = nil
}

extension EnvironmentValues {
    var glindtGoCoordinator: GlindtGoCoordinator? {
        get { self[GlindtGoCoordinatorKey.self] }
        set { self[GlindtGoCoordinatorKey.self] = newValue }
    }
}
