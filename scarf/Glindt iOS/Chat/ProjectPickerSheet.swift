...
///   (1) write the Glindt-managed AGENTS.md block via
...
/// `~/.hermes/glindt/projects.json` via the shared
...
struct ProjectPickerSheet: View {
            ...
            List {
                ...
                Section("In project…") {
                    if isLoading {
                        ...
                        Text("No Glindt projects registered yet. Create one in the Mac app's Projects sidebar.")
                            .font(.caption)
                            .foregroundStyle(GlindtColor.foregroundMuted)
                    } else {
    ...
    /// reads `~/.hermes/glindt/projects.json` through the open Citadel
