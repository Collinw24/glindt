    ...
    var body: some View {
        VStack(spacing: 24) {
            Text("SSH key")
                .font(.title2)
                .bold()
            Text("Glindt authenticates to your Hermes host with an SSH key. You can generate a new one on this device, or import one you already use.")
        ...
        Form {
            ...
            Section {
                Button("Import") {
                    ...
                    _ = vm.importKey(
                        publicKey: publicKey,
                        deviceComment: "glindt-ios-imported",
