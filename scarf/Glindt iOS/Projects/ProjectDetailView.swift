...
///
/// "New Chat" toolbar button calls `GlindtGoCoordinator.startChatInProject`
...
struct ProjectDetailView: View {
    ...
    /// Last-seen mtime on `<project>/.glindt/dashboard.json`. The
    ...
    private var tabContent: some View {
        ...
        case .kanban:
            GlindtGoKanbanView(project: project, context: serverContext)
        }
    }
