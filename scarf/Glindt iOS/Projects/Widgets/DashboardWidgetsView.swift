...
/// `glindt/Features/Projects/Views/ProjectsView.swift`. Unknown types
...
struct WidgetView: View {
    ...
    private var unsupportedView: some View {
        VStack(alignment: .leading, spacing: 6) {
            ...
            Text("This Glindt build doesn't render this widget type. Update Glindt or change the widget type in dashboard.json.")
                .font(.caption2)
        ...
        .padding(12)
        .background(GlindtColor.warning.opacity(0.08))
        .overlay(
            RoundedRectangle(cornerRadius: 8)
                .strokeBorder(GlindtColor.warning.opacity(0.3), lineWidth: 1)
        )
