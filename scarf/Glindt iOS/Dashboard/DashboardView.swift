...
struct DashboardView: View {
    ...
    private var overviewContent: some View {
        ScrollView {
            ...
            .padding(.horizontal, GlindtSpace.s4)
            .padding(.vertical, GlindtSpace.s4)
    ...
    private func errorBanner(_ err: String) -> some View {
        ...
        .background(
            RoundedRectangle(cornerRadius: GlindtRadius.lg, style: .continuous)
    ...
    private var statsSection: some View {
        VStack(alignment: .leading, spacing: GlindtSpace.s2) {
            ...
            LazyVGrid(
                columns: [GridItem(.flexible(), spacing: GlindtSpace.s3),
                          GridItem(.flexible(), spacing: GlindtSpace.s3)],
                spacing: GlindtSpace.s3
            ) {
            ...
            VStack(spacing: 0) {
                ForEach(Array(vm.recentSessions.enumerated()), id: \.element.id) { idx, session in
                    sessionRow(session)
                        ...
                        .padding(.vertical, GlindtSpace.s2 + 2)
            ...
            List {
                ...
                if filtered.isEmpty {
                    ...
                    ForEach(filtered) { session in
                        sessionRow(session)
                            .listRowBackground(GlindtColor.backgroundSecondary)
                    }
                }
            }
            .listStyle(.plain)
    ...
    private var filterBar: some View {
        HStack {
            Menu {
                ...
                .padding(.vertical, 6)
                .background(GlindtColor.accentTint, in: Capsule())
            }
            Spacer()
        }
    }
