...
### Cluster B — Glindt-side architectural choices (need user adjudication)
...
- **No data migrations.** Per CLAUDE.md, schema is unchanged from v0.11/v0.12 across this release. Per-project `manifest.json` and Glindt-owned sidecars at `~/.hermes/glindt/` are untouched.
