...
// ─────────────── Webhooks ───────────────
const WEBHOOKS = [
  { name: 'PR opened → review',   url: 'https://hooks.glindt.local/pr-review',   events: ['github.pr.opened'], status: 'active', last: '2h ago' },
  { name: 'Sentry → triage',      url: 'https://hooks.glindt.local/sentry-triage', events: ['sentry.issue.created', 'sentry.issue.regression'], status: 'active', last: '14m ago' },
  { name: 'Linear cycle → recap', url: 'https://hooks.glindt.local/cycle-recap', events: ['linear.cycle.completed'], status: 'paused', last: '8d ago' },
];
