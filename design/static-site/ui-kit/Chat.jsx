...
function Chat() {
  ...
  const sessions = [
    { id: 's1', title: 'Cron diagnostics', project: 'glindt', preview: 'The daily-summary job ran 14 minutes ago…', time: '14m', model: 'sonnet-4.5', unread: 0, pinned: true, status: 'live' },
    ...
    { id: 's5', title: 'Memory layout question', project: 'glindt', preview: 'The shared memory keys live at…', time: 'yesterday', model: 'sonnet-4.5', status: 'idle' },
    { id: 's6', title: 'Catalog publish flow', project: 'hermes-blog', preview: 'Walked through the .glindttemplate bundle…', time: 'yesterday', model: 'sonnet-4.5', status: 'idle' },
    { id: 's7', title: 'SSH tunnel debug', project: 'glindt-remote', preview: 'Connection drops after ~90s of idle…', time: 'Mon', model: 'sonnet-4.5', status: 'error' },
  ];
    ...
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0,
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '20px 28px 8px',
        ...
        <AssistantMsg time="9:42 AM" tokens={284} model="sonnet-4.5" durationMs={2140}>
          ...
          <ToolCall id="tc-1" kind="read" name="read_file" arg="~/.glindt/cron/jobs.json" duration="86 ms" focus={focused} setFocus={setFocused} />
        ...
        <AssistantMsg time="9:43 AM" tokens={612} model="sonnet-4.5" inProgress durationMs={4280}>
          <ToolCall id="tc-3" kind="read" name="read_file" arg="~/.glindt/cron/output/daily-summary.md" duration="42 ms" focus={focused} setFocus={setFocused} />
          ...
          <ul style={{ ...msgPara, paddingLeft: 18, margin: '4px 0' }}>
            <li>3 PRs merged across <code style={inlineCode}>hermes</code> and <code style={inlineCode}>glindt</code></li>
            <li>2 cron failures auto-recovered (gateway timeouts)</li>
            <li>Token spend down 8% week-over-week</li>
          </ul>
          <ToolCall id="tc-4" kind="edit" name="apply_patch" arg="~/.glindt/cron/jobs.json" duration="120 ms" diff focus={focused} setFocus={setFocused} />
        </AssistantMsg>
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{ fontSize: 11, color: 'var(--fg-muted)', display: 'flex', gap: 10, marginTop: 3, alignItems: 'center', flexWrap: 'wrap' }}>
          <span style={{ display: 'inline-flex', alignItems: 'center', gap: 4 }}>
            ...
            <span style={{ color: 'var(--accent)', fontWeight: 600 }}>glindt</span>
          </span>
          ...
          <div style={{ fontSize: 10, color: 'var(--fg-faint)', marginTop: 4, marginLeft: 4,
            ...
            {inProgress && <span style={{ display: 'inline-flex', alignItems: 'center', gap: 4 }}>
              <span style={{
                ...
                animation: 'pulseGlindt 1.4s ease-in-out infinite',
              }}></span>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
          <ContextChip icon="folder" label="glindt" tone="accent" />
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
          ...
          <ComposerChip icon="folder" label="glindt" />
...
function Inspector({ focused }) {
  ...
  const FOCUS_DATA = {
    'tc-1': { kind: 'read', name: 'read_file', arg: '~/.glindt/cron/jobs.json',
    ...
    'tc-2': { kind: 'execute', name: 'execute', arg: 'hermes cron status daily-summary',
      ...
      cwd: '~/.glindt', exitCode: 0 },
    'tc-3': { kind: 'read', name: 'read_file', arg: '~/.glindt/cron/output/daily-summary.md',
      duration: '42 ms', startedAt: '09:43:01.190', tokens: 1284 },
    'tc-4': { kind: 'edit', name: 'apply_patch', arg: '~/.glindt/cron/jobs.json',
        ...
        <Section title="Permissions" hint="Tool gateway policy applied at run time">
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
              ...
              <span>Allowed by <code style={inlineCode}>glindt-default</code> profile</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
