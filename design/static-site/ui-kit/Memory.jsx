...
const MEMORY_FILES = [
  { id: 'global', name: 'AGENTS.md', scope: 'Global', path: '~/.glindt/AGENTS.md', updated: '2 days ago', size: '1.2 KB' },
  { id: 'wizemann', name: 'AGENTS.md', scope: 'Org · Wizemann', path: '~/.glindt/orgs/wizemann/AGENTS.md', updated: '1 week ago', size: '3.4 KB' },
