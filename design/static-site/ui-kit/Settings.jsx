...
function Settings() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      <ContentHeader title="Settings" subtitle="Global preferences for Glindt. Per-project overrides live in each project." />
...
function GeneralTab() {
  return <>
    ...
    <SettingsGroup title="Updates">
      <SettingsRow icon="download" title="Auto-update Glindt"
...
function AppearanceTab() {
  return <>
    <SettingsGroup title="Theme">
      ...
      <SettingsRow icon="droplet" title="Accent" description="Glindt uses a warm rust accent across the app."
        control={
  ...
  return <>
    ...
    <SettingsGroup title="Danger zone">
      <SettingsRow icon="trash-2" title="Reset all settings"
        description="Returns Glindt to defaults. Projects and history are preserved."
  ...
  return <>
    <SettingsGroup title="Telemetry">
      <SettingsRow icon="bar-chart" title="Anonymous usage data"
        description="Helps improve Glindt. No prompts or file contents are sent."
        control={<Toggle on={true} />} />
