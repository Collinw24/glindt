// Glindt v2 shared components — calmer density, full state matrices.
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'flex-end', gap: 16 }}>
        <div style={{ flex: 1 }}>
          <div className="glindt-h2" style={{ marginBottom: subtitle ? 6 : 0 }}>{title}</div>
...
function Spinner({ size = 14, color = 'currentColor' }) {
  return (
    <span style={{
      ...
      borderRadius: '50%', animation: 'glindtSpin 0.8s linear infinite',
    }}></span>
  );
}
