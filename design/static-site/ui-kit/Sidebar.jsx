// Glindt Sidebar — sectioned nav matching SidebarView.swift
...
function GlindtSidebar({ active, onSelect }) {
  return (
    <aside style={{
      ...
      <div style={{ padding: '0 16px 12px', display: 'flex', alignItems: 'center', gap: 8 }}>
        <img src="../../assets/glindt-app-icon-128.png" width="22" height="22" style={{ borderRadius: 5 }} alt="" />
        <div style={{ fontSize: 14, fontWeight: 600, letterSpacing: '-0.01em' }}>Glindt</div>
...
window.GlindtSidebar = GlindtSidebar;
