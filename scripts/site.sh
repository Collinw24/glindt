#!/usr/bin/env bash
#
# Glindt landing-site helper — builds the marketing landing page from
...
#   {{VERSION}}        — current Glindt version (read from appcast.xml on
...
for tpl in catalog.get("templates", []):
    ...
    out.append(
        f'  <url>\n'
        f'    <loc>https://awizemann.github.io/glindt/templates/{slug}/</loc>\n'
