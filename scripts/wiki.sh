#!/usr/bin/env bash
#
# Glindt wiki helper — wraps the local .wiki-worktree/ clone with a secret-scan.
#
# Usage:
...
#   2. Visit https://github.com/awizemann/glindt/wiki and save any first page
...
WIKI_REMOTE="git@github.com:awizemann/glindt.wiki.git"
...
cmd_push() {
  ...
  log "Pushed. Verify at https://github.com/awizemann/glindt/wiki"
}
