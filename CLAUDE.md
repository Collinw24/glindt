# Glindt — macOS GUI for the Hermes AI Agent
...
- Search: `basic-memory tool search-notes --project glindt "<query>"` (or the basic-memory MCP).
- Record durable facts/decisions as you work: `basic-memory tool write-note --project glindt …`
...
- After editing a note file directly, reindex: `basic-memory reindex --project glindt`.
...
- Search: `basic-memory tool search-notes --project glindt-wiki "<query>"`, or grep:
  `grep -rn "<query>" wiki/`.
...
- Search: `basic-memory tool search-notes --project glindt-design "<query>"`, or grep:
