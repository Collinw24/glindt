...
- **Vercel removed** — Vercel AI Gateway (provider) and Vercel Sandbox (terminal backend) were deleted from Hermes in v0.15 and are dropped from Glindt's picker and terminal-backend list.
