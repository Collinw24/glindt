...
type: note
permalink: glindt-wiki/mcp-servers-plugins-webhooks-tools
---
...
Hermes plugins are git-cloned into `~/.hermes/plugins/`. Glindt reads the directory directly for reliable state.
...
---
_Last updated: 2026-05-28 — Glindt v2.10.0 (MCP mTLS client certs for HTTP + SSE servers + read-only `hermes mcp catalog` browse sheet)_