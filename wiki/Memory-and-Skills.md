...
type: note
permalink: glindt-wiki/memory-and-skills
---
...
- **SKILL.md frontmatter chips.** Hermes v0.11 SKILL.md files carry richer YAML frontmatter (`allowed_tools`, `related_skills`, `dependencies`). Glindt parses it on both platforms and renders chip rows in the skill detail view. Old skills without these fields stay nil and the rows hide themselves.
...
---
_Last updated: 2026-05-28 — Glindt v2.10.0 (read-only skill Bundles tab over `~/.hermes/skill-bundles/*.yaml`)_